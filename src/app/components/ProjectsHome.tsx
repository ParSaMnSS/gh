  ...
  const projects = [
    {
      ...
      description: "We produce high-quality broiler and layer poultry feed for all stages.",
    ...
    },
    {
      ...
      description: "We grow poultry without the use of drugs and antibiotics in our specialized farms.",
    ...
    },
    {
      ...
      description: "Our laboratories conduct experiments to make our products as healthy as possible.",
    ...
    },
    {
      ...
      description: "We offer import-export services, including hatching eggs, feed additives, and raw materials.",
      link: "/projects/trade",
    },
  ];
